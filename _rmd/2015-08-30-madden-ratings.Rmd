...
```{r, echo=FALSE}
knitr::opts_chunk$set(fig.path='{{ site.url }}/images/madden-ratings-', message = FALSE, warning=FALSE)
```
...
Every category takes on ratings values from 0 to 99, so, for reference, the maximum possible $Athleticism$ score would be `r 99*3`. Below are the 20 highest rated players. 
